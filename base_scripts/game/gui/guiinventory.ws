...
class CGuiInventory extends CGuiPanel
{
	...
	function AddBookKnowledge( itemName : name )
	{
		...
		{ 
			thePlayer.AddJournalEntry( JournalGroup_Glossary, "Powstanie w Wyzimie", "Powstanie w Wyzimie 0",  "Politics", "glossariusz_256x256" );
		...
		{ 
			thePlayer.AddJournalEntry( JournalGroup_Glossary, "Glossary Vejopatis", "Glossary Vejopatis 0",  "Culture", "glossariusz_256x256" ); 
		}
