...
mBoolean( true ) );
	...
	function TriggerMedalionFX()
	{
		...
		if ( m_canUseMedallion )
		{
			...
			AddTimer( 'OnEnableMedallion', 2.f, false );//===ProjectMersey===
...
/////////////////////// DLC ///////////////////////////////////
	...
	event OnDlc_alchemy_suit()
	{
		...
		//GetInventory().AddItem( 'White Myrtle Petals', 15, true );//White myrtle petals
		//GetInventory().AddItem( 'Hellebore Petals', 15, true );//Scleroderm
		//GetInventory().AddItem( 'Celandine', 15, true );//Celandine
		GetInventory().AddItem( 'Beggartick Blossoms', 8, true );//Cortinarius
		GetInventory().AddItem( 'Mandrake Root', 8, true );//Mandrake root
		GetInventory().AddItem( 'Wolfsbane', 8, true );//Wolfsbane
		//GetInventory().AddItem( 'Bryony', 10, true );//Bryonia
		GetInventory().AddItem( 'Verbena', 8, true );//Verbena
		GetInventory().AddItem( 'Balisse', 8, true );//Balisse
		*/
	}
	...
	event OnDlc_swordsman_suit()
	{
		...
		GetInventory().AddItem( 'Brown Oil', 4, true );//Necrophage Oil
		GetInventory().AddItem( 'Hangman Venom', 4, true );//Hanged Man's Venom
		GetInventory().AddItem( 'Crinfrid Oil', 4, true );//Insectoid Oil
		GetInventory().AddItem( 'Specter Grease', 4, true );//Specter Oil
		GetInventory().AddItem( 'Caelm', 4, true );//Brown Oil
		GetInventory().AddItem( 'Cerbin Blath', 4, true );//Falka's Blood
		GetInventory().AddItem( 'Surge', 4, true );//Arachnid Oil
		//GetInventory().AddItem( 'Argentia', 4, true );//Whirl
		*/
	}
